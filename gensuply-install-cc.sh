...
docker exec cli peer chaincode instantiate -o orderer.example.com:7050 --tls true --cafile $ORDERER_CA -C channelone $chainname.out -n $chainname -v 1.0 -l node -c '{"Args":["init"]}'  -P "OR ('Org1MSP.member' , 'Org1MSP.peer')"
### signpackage
